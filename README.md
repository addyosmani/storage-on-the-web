...
| DOM Storage | ✔    |                     |             |        |                 | Size-limited, only strings.  Not hooked up to Quota Manager. Not available in a Web/Service Worker.               | [localForage][], [PouchDB][], [ydn-db][]              
...
| WebSQL      |      | ✔  (callback based) |             |        |                 | Rejected by Edge, Firefox.  Likely to unship in Chrome. Not available in a Web/Service Worker.                                                          | [localForage][], [PouchDB][], [Lovefield][], [ydn-db][]                   |
